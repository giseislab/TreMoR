...
uimenu(drmh,'Label', 'Max', 'Callback', {@dr_callback, w, subnet, 'body', 'max'});
uimenu(drmh,'Label', 'Mean', 'Callback', {@dr_callback, w, subnet, 'body', 'mean'});
uimenu(drmh,'Label', 'Median', 'Callback', {@dr_callback, w, subnet, 'body', 'median'});
uimenu(drmh,'Label', 'RMS', 'Callback', {@dr_callback, w, subnet, 'body', 'rms'});
drsmh=uimenu(reddispmh,'Label', 'Surface wave');
uimenu(drsmh,'Label', 'Max', 'Callback', {@dr_callback, w, subnet, 'surface', 'max'});
uimenu(drsmh,'Label', 'Mean', 'Callback', {@dr_callback, w, subnet, 'surface', 'mean'});
uimenu(drsmh,'Label', 'Median', 'Callback', {@dr_callback, w, subnet, 'surface', 'median'});
