function w=gui_waveform(subnet, scnl, snum, enum, ds, varargin)
...
% load the data
w=waveform_load(subnet, scnl(1), snum, enum, ds, 'remove_calibs', remove_calibs, 'remove_spikes', remove_spikes, 'remove_trend', remove_trend, 'remove_response', remove_response, 'interactive_mode', interactive_mode, 'lowcut', lowcut, 'highcut', highcut);
...
function w=waveform_load(subnet, scnl, snum, enum, ds, varargin)
[remove_calibs, remove_spikes, remove_trend, remove_response, interactive_mode, lowcut, highcut] = process_options(varargin, 'remove_calibs', true, 'remove_spikes', true, 'remove_trend', true, 'remove_response', false, 'interactive_mode', false, 'lowcut', 0.5, 'highcut', 20.0);
